...
ここからわかるのは, 三国志6以前で呉に属する人物のステータスの低さである. 確かに, 三国志2では呉で武力が90を超える人物は孫堅 (90), 孫策 (94), 太史慈 (95), 甘寧 (92) の4名である一方, 武勇を示すエピソードの多い武将でも<ruby>**周泰**<rp>(</rp><rt>シュウタイ</rt><rp>)</rp></ruby> (85),   <ruby>**呂蒙**<rp>(</rp><rt>リョモウ</rt><rp>)</rp></ruby>(83), <ruby>**董襲**<rp>(</rp><rt>トウシュウ</rt><rp>)</rp></ruby> (56) などと低く設定されていると感じる. 一方で魏・蜀はともに武力が90を超える人物は10名以上存在する. 実態として呉の人材が豊富でなかったという話ではなく, 作品ごとの推移でみると最近の作品ほど分布の形が徐々に画一化してきているという意味である.
